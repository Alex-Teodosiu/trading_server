...
class TradingAccount:
    def __init__(self, id: UUID, account_number: str, status: str, crypto_status: str, currency: str, buying_power: str, 
                 ...
                 options_buying_power: str, options_approved_level: int, options_trading_level: int):
        self.id = id
    ...
    def __str__(self):
        return f"TradeAccount(id={self.id}, account_number={self.account_number}, status={self.status}, crypto_status={self.crypto_status}, currency={self.currency}, buying_power={self.buying_power}, regt_buying_power={self.regt_buying_power}, daytrading_buying_power={self.daytrading_buying_power}, non_marginable_buying_power={self.non_marginable_buying_power}, cash={self.cash}, accrued_fees={self.accrued_fees}, pending_transfer_out={self.pending_transfer_out}, pending_transfer_in={self.pending_transfer_in}, portfolio_value={self.portfolio_value}, pattern_day_trader={self.pattern_day_trader}, trading_blocked={self.trading_blocked}, transfers_blocked={self.transfers_blocked}, account_blocked={self.account_blocked}, created_at={self.created_at}, trade_suspended_by_user={self.trade_suspended_by_user}, multiplier={self.multiplier}, shorting_enabled={self.shorting_enabled}, equity={self.equity}, last_equity={self.last_equity}, long_market_value={self.long_market_value}, short_market_value={self.short_market_value}, initial_margin={self.initial_margin}, maintenance_margin={self.maintenance_margin}, last_maintenance_margin={self.last_maintenance_margin}, sma={self.sma}, daytrade_count={self.daytrade_count}, options_buying_power={self.options_buying_power}, options_approved_level={self.options_approved_level}, options_trading_level={self.options_trading_level})"
